...
| skipModuleVersionInOutputFile  | No       | FALSE                                 | Whether to add or not the module version in the changed projects output. <br/> Ex. with version com.acme:helloworld:1.0.0 <br/> Ex. without version com.acme:helloworld                                                                                  |
| skipFilePathInOutputFile       | No       | TRUE                                  | Whether to add the filepath to the changed project output. <br/> Ex. with version com.acme:helloworld:1.0.0, /home/userid/project/acme/helloworld <br/>                                                                                 |
